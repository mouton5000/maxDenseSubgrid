...
\begin{remark}
	As for the LCL algorithm, we can also adapt the instance of the external report \cite{WatelPoirionAppendix} in order to lure the greedy algorithm and prove it is at least a $\sqrt{n}$-approximation algorithm.
\end{remark}
